...
If a Licensee's failure to comply with the conditions of the VOD Reaction License Version 0.4 is discovered (e.g., improper attribution, publication on a non-Permitted Platform, or other breaches), the Licensee's rights to use your VODs under that license terminate automatically, as per Clause 8 of the License.
</details>
