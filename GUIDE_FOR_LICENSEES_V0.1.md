...
This guide explains the main steps and important points for reusing VODs (past stream recordings) from **\[Licensor's Primary Channel Name\]** (hereinafter "Licensor," "we," or "us") to create and publish new content (hereinafter "Streamed Work") under our "VOD Reaction License Version 1.0" (hereinafter "the License").
