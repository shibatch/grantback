...
* Changing Placeholder Information (e.g., Your Attribution Channel Name): If you need to update the information you provided in the placeholders of your published VOD Reaction License (for example, if your channel name used for attribution changes), it is crucial to handle this transparently and fairly:  
  * Communicate the Change: Clearly announce the change to your community (e.g., on your channel, social media, or wherever you post license updates).  
  * Effective Date: Specify that the new information applies to Streamed Works created *after* the date of your announcement/update.  
  * Existing Works: Reassure your community that Streamed Works created and published in compliance with the placeholder information that was current *at the time of their creation* will still be considered compliant. You should not retroactively demand changes to attribution for already existing compliant works based on your new details.  
  * Versioning Your License Instance (Optional but Recommended): If you make significant changes to placeholder information that affects how Licensees comply (like attribution details), consider versioning your specific instance of the license (e.g., by adding a "Last Updated \[Date\]" note to your hosted license document) and clearly communicating which version applies to which period of VOD reuse.  
...
This approach to the License Template text is designed to ensure that any license publicly identified as a "VOD Reaction License Version 0.1.1" maintains a consistent set of core terms, which benefits both Licensors and Licensees by providing predictability and clarity across the community.  
